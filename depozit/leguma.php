        ...
        <div align="center">
                <div id="container">
                        ...
                        <ul id="menu">
                                ...
                                <li><a href="legume.php" class="current">Legume</a></li>
                        ...
                        <div id="continut">
                                <div style="padding:20px 20px 20px 20px;">
                                        ...
                                        <?php
                                        $interogare = "SELECT * FROM legume WHERE id = " . $leguma;
                                        ...
                                        while ($row = mysqli_fetch_array($rezultat)) {
                                                ...
                                                if ($row['cantitate'] > 200) {
                                                        echo 'Disponibilitate: <b>In stoc</b>';
                                                } else if ($row['cantitate'] > 0) {
                                                        echo 'Disponibilitate: <b>Stoc limitat</b>';
                                                } else {
...
<input type="text" name="kg" style="width:100px; border:1px solid #F60; font-weight:bold;background-color:#999; color:#000;">
<INPUT type="hidden" name="id" value="' . $leguma . '" >
